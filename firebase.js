...
const { getFirestore, collection, query, where, getDocs, addDoc, setDoc } =  require("firebase/firestore");
...
module.exports = { db, collection, query, where, getDocs, addDoc, setDoc };
